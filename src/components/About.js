  ...
  return (
    <div className="about">
      ...
      <div>
        ...
        Development Bootcamp. I have a degree in mathematics and 10 years of experience in teaching. Teaching MS/HS math and Japanese, I developed strong intepersonal skills that I believe can be beneficial to the tech field. Working in the preschool setting taught me many valuable lessons that I hold dearly. I am particularly passionate about people and making positive changes in education, therefore I would love to work for a company that strives towards improving and supporting education in the community. 
